...
function Trending(){
    ...
    const records=trendingBooks.slice(firstIndex,lastIndex);
    const numberOfPages=Math.ceil(trendingBooks.length/booksPerPage);
        ...
        const handleFetch= async ()=>{
            try{
                const response=await axios.get("https://booklust-backend.onrender.com/books",{
                    params:{category:"trending",limit:10},});
